"""
This script is called by the plugin-wrapper, CreateSmartCicCosts.js, which passes down the
...
from CreateSmartCicCosts import CreateSmartCicCosts
...
plugin = CreateSmartCicCosts(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
