"""
This script is called by the plugin-wrapper, ImportSuppliers.js, which passes down the
...
from ImportSuppliers import ImportSuppliers
...
plugin = ImportSuppliers(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
