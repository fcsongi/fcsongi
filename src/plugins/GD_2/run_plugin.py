"""
This script is called by the plugin-wrapper, GD_2.js, which passes down the
...
plugin = GD_2(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
