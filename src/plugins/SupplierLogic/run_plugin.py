"""
This script is called by the plugin-wrapper, SupplierLogic.js, which passes down the
...
from SupplierLogic import SupplierLogic
...
plugin = SupplierLogic(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
