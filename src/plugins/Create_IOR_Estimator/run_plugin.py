"""
This script is called by the plugin-wrapper, Create_IOR_Estimator.js, which passes down the
...
from Create_IOR_Estimator import Create_IOR_Estimator
...
plugin = Create_IOR_Estimator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
