"""
This script is called by the plugin-wrapper, SilverpeakParts.js, which passes down the
...
from SilverpeakParts import SilverpeakParts
...
plugin = SilverpeakParts(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
