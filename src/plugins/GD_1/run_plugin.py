"""
This script is called by the plugin-wrapper, GD_1.js, which passes down the
...
plugin = GD_1(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
