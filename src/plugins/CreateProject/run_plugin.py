"""
This script is called by the plugin-wrapper, CreateProject.js, which passes down the
...
plugin = CreateProject(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
