"""
This script is called by the plugin-wrapper, VelocloudParts.js, which passes down the
...
from VelocloudParts import VelocloudParts
...
plugin = VelocloudParts(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
