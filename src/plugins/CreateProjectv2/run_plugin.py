"""
This script is called by the plugin-wrapper, CreateProjectv2.js, which passes down the
...
from CreateProjectv2 import CreateProjectv2
...
plugin = CreateProjectv2(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
