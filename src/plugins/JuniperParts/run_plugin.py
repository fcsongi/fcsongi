"""
This script is called by the plugin-wrapper, JuniperParts.js, which passes down the
...
from JuniperParts import JuniperParts
...
plugin = JuniperParts(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
