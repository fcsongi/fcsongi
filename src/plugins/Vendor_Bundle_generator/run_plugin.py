"""
This script is called by the plugin-wrapper, Vendor_Bundle_generator.js, which passes down the
...
from Vendor_Bundle_generator import Vendor_Bundle_generator
...
plugin = Vendor_Bundle_generator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
